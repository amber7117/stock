window.addEventListener("load", function () {
    var maxHeight = 0;
    $(".voice__card, .dlpo-voice-tokyo__card, .dlpo-voice-osaka__card").each(function (idx, elem) {
        var height = $(elem).height();
        if (maxHeight < height) {
            maxHeight = height;
        }
    });
    $(".voice__card, .dlpo-voice-tokyo__card, .dlpo-voice-osaka__card").height(maxHeight);
});
