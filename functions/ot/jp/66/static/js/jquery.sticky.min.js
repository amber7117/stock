!function(t) {
    var o = function(o, s) {
        var e, i, r = !1, n = !1, a = !1, c = {}, f = {
            ...
            c.$spacer.remove(),
            r = !1,
            e.trigger("sticky:unstick")
        }, v = function() {
            var t = y(e)
              , o = "top" === i.to;
            if (n) {
                (o ? t.top.fromTop > i.offset : t.bottom.fromBottom < -i.offset) && (c.$parent.css(l(c.$parent, "childNotFollowing")),
            ...
            if (r) {
                ...
                var n = y(e);
                (t = "top" === i.to ? n.top.fromTop - o : -n.bottom.fromBottom - o) <= 0 && (h(),
                i.parent && v())
            }
            !function(t) {
                a && -t < i.effectsOffset ? (e.removeClass(i.classes.stickyEffects),
                a = !1) : !a && -t >= i.effectsOffset && (e.addClass(i.classes.stickyEffects),
                a = !0)
            }(t)
        }, b = function() {
            g()
