    ...
    9728: (e,t)=>{
        ...
        class baseTabs extends elementorModules.frontend.handlers.Base {
            ...
            activateTab(e) {
                ...
                i[t.showTabFn](o, (()=>elementorFrontend.elements.$window.trigger("elementor-pro/motion-fx/recalc"))),
                i.removeAttr("hidden")
            }
            isActiveTab(e) {
        ...
        e.exports = elementorModules.ViewModule.extend({
            ...
            getSlideshowHeader: function() {
                ...
                if (s || n || o || a) {
                    ...
                    if (o) {
                        ...
                        n.push(d.$iconZoom),
                        this.isFontIconSvgExperiment && (d.$iconZoomOut = t(i.zoomOutBold.element).attr(o).addClass(r.hidden).on("click", this.toggleZoomMode),
                    ...
                    if (n) {
                        ...
                        d.$iconExpand = t(s).append(t("<span>"), t("<span>")).attr(a).on("click", this.toggleFullscreen),
                        n.push(d.$iconExpand),
                        this.isFontIconSvgExperiment && (d.$iconMinimize = t(i.frameMinimize.element).attr(o).addClass(r.hidden).on("click", this.toggleFullscreen),
            ...
            setSlideshowContent: function(e) {
                const {i18n: t} = elementorFrontend.config
                  ...
                  , a = "" !== elementorFrontend.getKitSettings("lightbox_description_src")
                  , r = o || a
